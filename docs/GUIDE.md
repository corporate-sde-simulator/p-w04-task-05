...
> **Welcome to Product-Track Week 4, Task 5!**
...
| `src/healthChecker.js` | Main source code - **has bugs to fix** |
| `src/serviceRegistry.js` | Supporting code - **may also have bugs** |
| `tests/healthChecker.test.js` | Test file - **add your tests here** |
