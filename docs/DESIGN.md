# Architecture Decision Record - Service health check orchestrator
...
Implement Service health check orchestrator using industry-standard patterns appropriate for nodejs and our platform requirements.
